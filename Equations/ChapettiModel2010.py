...
class Model(object):
    def __init__(self, aesmm = [0.02], C = 6.0e-10, m=2.2, kt=1., Yu=0.65, Y=1.12, dmm = 0.02, D=0.0, rho=0.0, DKthR=10.1, deltaSigmaR = 375., deltaSigmaN = 650., DKths = 2.0, eqType = 'Zheng', crackType = 'Long', name=None, parent = None):
        ...
        # --------------------------------------------------------------------------------------- 
        # --------------------------------------------------------------------------------------- Zona a modificar según parámetros del usuario.
    
        self.Id = None
        self.parentId = None
        self.parent = None
        self.name = name                                # nombre de la ecuación, renombrable.

        self.model_name = "Chapetti2010"             # este es el nombre que aparece en pantalla, no renombrable.
    ...
    # --------------------------------------------------------------------------------------- fin zona a modificar según parámetros del usuario
    # ---------------------------------------------------------------------------------------
...
# -------------------------
    ...
    # --------------------------------------------------------------------------- Setters y getters creados a partir de parámetros del usuario        
    ...
    # --------------------------------------------------------------------------- fin de setters y getters creados a partir de parámetros del usuario    


    # --------------------------------------------- Métodos que van siempre.
    def is_equation(self):
        return True
    ...
    # --------------------------------------------- fin métodos que van siempre.
    
    # --------------------------------------------- Métodos del usuario. Eval tiene que estar sí o sí.    
